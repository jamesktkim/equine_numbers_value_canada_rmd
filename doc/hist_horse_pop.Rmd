...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1", out.width= "100%"}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
kable(max_horses, caption = "Table 1. Max and min number of horses for each province between 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2", out.width="50%"}
