...
The R programming language and the following (R Core Team 2021) packages
were used to perform the analysis: knitr (Xie 2021) and tidyverse
...
<img src="hist_horse_pop_files/figure-gfm/plot horses-1.png" title="Figure 1" alt="Figure 1" width="100%" />
...
Table 1. Max and min number of horses for each province between 1940 -
1972

Below we zoom in and look at the province of Alberta:

<img src="hist_horse_pop_files/figure-gfm/plot province-1.png" title="Figure 2" alt="Figure 2" width="50%" />
